    ...
    return """
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              <p>Hello <strong>%s</strong>,</p>
              <p>Thank you for Choosing <strong>TechRestore</strong> as a %s!</p>
              <p>We would like to Notiy you that your Payment not completed</p>
              <p>Contact us to help you to solve this issue </trong>to be able to recieve your order</strong></p>
              <p>Best regards,<br>
              <strong>The TechRestore Teamc</p>
            </div>
          </div>
        </body>
        </html>
