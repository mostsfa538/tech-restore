...
public class ChatRestController {
    ...
    public ResponseEntity<List<ChatSessionDTO>> getMyChatSessions() {
        return ResponseEntity.ok(chatService.getSessionsForCurrentUser());
    }


    @GetMapping("/shop/sessions")
    @PreAuthorize("hasRole('SHOP_OWNER')")
    public ResponseEntity<List<ChatSessionDTO>> getShopChatSessions() {
        return ResponseEntity.ok(chatService.getSessionsForCurrentShop());
    }
}
