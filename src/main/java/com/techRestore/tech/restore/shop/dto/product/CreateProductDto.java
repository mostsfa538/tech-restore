...
public record CreateProductDto(
        ...
        @NotBlank(message = "Product image URL cannot be blank") @URL(message = "Invalid URL format") String imageUrl,

        @NotNull(message = "Product category cannot be null") Category category,
